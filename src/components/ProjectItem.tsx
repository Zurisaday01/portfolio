...
const ProjectItem = ({ project }: ProjectItemProps) => {
	...
	return (
		<div className='flex flex-col items-start gap-4 bg-gray-transparent p-10 hover:bg-gray-transparent-strong transition duration-300 ease-in-out hover:scale-105 hover:outline outline-primary-2 outline-offset-8 outline-4 hover:shadow-[0_0px_30px_rgba(0,0,0,0.4)]'>
